...
Текущая версия — **0.6.2**. Она собрана для Valheim **1.0.7**, Steam build **25185596**, network version **39**, Unity **6000.0.75f1**, BepInExPack Valheim **5.4.2350** и Jotunn **2.29.2**.

> EarthWorks 0.6.2 — проверенная статически и автоматическими тестами development-сборка. Полный runtime acceptance в одиночной и сетевой игре ещё не завершён.
...
1. Установить BepInExPack Valheim 5.4.2350 и Jotunn 2.29.2.
2. Скачать `EarthWorks-0.6.2.zip` из GitHub Releases.
...
Для версии 0.6.2 автоматические geometry-тесты проходят **24/24**, а API-аудит подтверждает актуальные интерфейсы, Harmony targets и reflection-контракты Valheim 1.0.7.
...
- [Подробности релиза 0.6.2](docs/RELEASE_0.6.2.md)
