...
namespace OstrixMods.EarthWorks
{
    internal static class EarthWorksLocalization
    {
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            { "editor_select_drag", "Select a point with LMB and drag it directly." },
            { "editor_curve_type", "Curve type" },
            { "editor_smoothing", "X-Spline smoothing: {0}%" },
            { "editor_smoothing_legend", "0 Corner     50 Through point     100 B-Spline" },
        ...
        private static readonly Dictionary<string, string> Russian = new Dictionary<string, string>
        {
            ...
            { "editor_select_drag", "Выбери точку ЛКМ и перетаскивай её сразу." },
            { "editor_curve_type", "Тип кривой" },
            { "editor_smoothing", "Сглаживание X-Spline: {0}%" },
            { "editor_smoothing_legend", "0 Угол     50 Через точку     100 B-Spline" },
